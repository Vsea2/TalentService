				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('baoxiuxinxi','处理登记')" @click="weixiuchuliCrossAddOrUpdateHandler(scope.row,'cross','','','zhuangtai','已处理','已处理,待处理'.split(',')[0])" type="success">
...
import weixiuchuliCrossAddOrUpdate from "../weixiuchuli/add-or-update";
	export default {
		...
		methods: {
			...
			weixiuchuliCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
