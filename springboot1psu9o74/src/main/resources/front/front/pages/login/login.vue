	...
	<view class="content">
		<view class="box" :style='{"width":"100%","padding":"160rpx 0 0 0","backgroundSize":"100% 100%","position":"relative","backgroundImage":"url(http://codegen.caihongy.cn/20231129/8a45413f19f5441ab00f4650d3f7d43e.png)","height":"100%"}'>
			<view :style='{"width":"100%","padding":"40rpx 100rpx","display":"block","height":"auto"}'>
				...
				<button v-if="loginType==1" class="btn-submit" @tap="onLoginTap" type="primary" :style='{"border":"0","padding":"0px","margin":"0 0 24rpx 0","color":"rgb(255, 255, 255)","borderRadius":"0","background":"#D4CF5D","width":"100%","lineHeight":"88rpx","fontSize":"40rpx","height":"88rpx"}'>登陆</button>
				...
				<view class="links" :style='{"width":"100%","margin":"0 0 24rpx 0","flexWrap":"wrap","display":"flex","height":"auto"}'>
					<view class="link-highlight" @tap="onRegisterTap('yonghu')" :style='{"color":"#999","padding":"8rpx","fontSize":"28rpx"}'>注册用户</view>
					<view @tap="onForgetTap" :style='{"width":"100%","padding":"8rpx","fontSize":"28rpx","color":"#999","textAlign":"right"}'>忘记密码？</view>
				</view>
